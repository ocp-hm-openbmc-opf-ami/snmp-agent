...
static constexpr const char* smtpPriIntf =
    "xyz.openbmc_project.mail.alert.primary";
static constexpr const char* smtpSecIntf =
...
void init_netSnmpAMIScalars(void)
{
    ...
    netsnmp_register_scalar(netsnmp_create_handler_registration(
        "amiSnmpSMTPPriStatus", handle_amiSnmpSMTPPriStatus,
        amiSnmpSMTPPriStatus_oid, OID_LENGTH(amiSnmpSMTPPriStatus_oid),
        HANDLER_CAN_RWRITE));
    netsnmp_register_scalar(netsnmp_create_handler_registration(
        "amiSnmpSMTPSecStatus", handle_amiSnmpSMTPSecStatus,
        amiSnmpSMTPSecStatus_oid, OID_LENGTH(amiSnmpSMTPSecStatus_oid),
        HANDLER_CAN_RWRITE));

    netsnmp_register_scalar(netsnmp_create_handler_registration(
        "amiACD_DataArea", handle_amiACD_DataArea, amiACD_DataArea_oid,
        OID_LENGTH(amiACD_DataArea_oid), HANDLER_CAN_RWRITE));

    netsnmp_register_scalar(netsnmp_create_handler_registration(
        "amiACD_Trigger", handle_amiACD_Trigger, amiACD_Trigger_oid,
        OID_LENGTH(amiACD_Trigger_oid), HANDLER_CAN_RWRITE));
}
                           ...
                           netsnmp_request_info* requests)
{
    ...
    switch (reqinfo->mode)
    {
        case MODE_GET:
            try
            {
                dataArea = dbus_call<uint16_t>(acdBusName, acdObjPath, acdIntf,
                                               "Get_DataArea");
            }
            ...
            snmp_set_var_typed_value(requests->requestvb, ASN_OCTET_STR,
                                     (u_char*)&dataArea, sizeof(dataArea));
            break;
        ...
        case MODE_SET_ACTION:
            ...
            try
            {
                std::string setDataAreaResponse = dbus_call<std::string>(
                    acdBusName, acdObjPath, acdIntf, "Set_DataArea", dataArea);
            }
            catch (const std::exception& e)
            {
                std::cerr << "Error calling D-Bus method: " << e.what() << '\n';
                          ...
                          netsnmp_request_info* requests)
{
    ...
    switch (reqinfo->mode)
    {
        case MODE_GET:
            snmp_set_var_typed_value(requests->requestvb, ASN_OCTET_STR,
                                     (const u_char*)acd_Trigger.c_str(),
                                     acd_Trigger.size());
            break;
        ...
        case MODE_SET_ACTION:
            ...
            try
            {
                acd_Trigger = dbus_call<std::string>(acdBusName, acdObjPath,
                                                     acdIntf, "ACD_trigger");
            }
            catch (const std::exception& e)
            {
...
int handle_amiSnmpSMTPPriStatus(
    ...
    netsnmp_agent_request_info* reqinfo, netsnmp_request_info* requests)
{
    ...
    {
        case MODE_GET:
            getDbusProperty(smtpclient, smtpObj, smtpPriIntf, "Enable",
                            variant);
        ...
        case MODE_SET_ACTION:
            ...
            variant = (status != 0);
            setDbusProperty(smtpclient, smtpObj, smtpPriIntf, "Enable",
                            variant);
            snmp_set_var_typed_value(requests->requestvb, ASN_INTEGER,
        ...
        default:
            snmp_log(LOG_ERR,
                     "unknown mode (%d) in handle_amiSnmp_SMTP_status\n",
                     reqinfo->mode);
...
int handle_amiSnmpSMTPSecStatus(
    netsnmp_mib_handler* handler, netsnmp_handler_registration* reginfo,
    netsnmp_agent_request_info* reqinfo, netsnmp_request_info* requests)
{
    int ret;
    ...
    {
        case MODE_GET:
            getDbusProperty(smtpclient, smtpObj, smtpSecIntf, "Enable",
                            variant);
            status = std::get<bool>(variant);
            snmp_set_var_typed_value(requests->requestvb, ASN_INTEGER,
                                     (u_char*)&status, sizeof(int));
        ...
        case MODE_SET_ACTION:
            ...
            variant = (status != 0);
            setDbusProperty(smtpclient, smtpObj, smtpSecIntf, "Enable",
                            variant);
            snmp_set_var_typed_value(requests->requestvb, ASN_INTEGER,
                                     (u_char*)&status, sizeof(status));
            break;
